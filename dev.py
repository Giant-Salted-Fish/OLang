...
SYNTAX_RULES = [
	...
	('if', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'else'), ignore),
	...
	('if$-else', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'ELSE', 'prefix*', 'if$-else'), ignore),
	...
	('if$-else prefix*', ('IF', 'postfixed', 'postfixed', 'prefix*'), ignore),
	('if$-else prefix*', ('IF', 'postfixed', 'prefix*', '(if|if$-else) prefix*'), ignore),
	('if$-else prefix*', ('IF', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*'), ignore),
	('if$-else prefix*', ('IF', 'prefix*', '[^postfixed] prefix*', '(if|if$-else) prefix*'), ignore),
	('if$-else prefix*', ('IF', 'postfixed', 'postfixed', 'prefix*', 'ELSE', 'prefix*', 'if$-else prefix*'), ignore),
	('if$-else prefix*', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'ELSE', 'prefix*', 'if$-else prefix*'), ignore),
	('if$-else prefix*', ('IF', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*', 'ELSE', 'prefix*', 'if$-else prefix*'), ignore),
	...
	('if$-case', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'ELSE', 'prefix*', '(if$-case|match)'), ignore),
	...
	('if$-case prefix*', ('IF', 'postfixed', 'postfixed', 'prefix*', 'ELSE', 'prefix*', '(if$-case|match) prefix*'), ignore),
	('if$-case prefix*', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'ELSE', 'prefix*', '(if$-case|match) prefix*'), ignore),
	('if$-case prefix*', ('IF', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*', 'ELSE', 'prefix*', '(if$-case|match) prefix*'), ignore),
	...
	('if$-else-case', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'ELSE', 'prefix*', '(if$-else-case|match$-else)'), ignore),
	...
	('if$-else-case prefix*', ('IF', 'postfixed', 'prefix*', '(if$-case|if$-else-case|match|match$-else) prefix*'), ignore),
	('if$-else-case prefix*', ('IF', 'prefix*', '[^postfixed] prefix*', '(if$-case|if$-else-case|match|match$-else) prefix*'), ignore),
	('if$-else-case prefix*', ('IF', 'postfixed', 'postfixed', 'prefix*', 'ELSE', 'prefix*', '(if$-else-case|match$-else) prefix*'), ignore),
	('if$-else-case prefix*', ('IF', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*', 'ELSE', 'prefix*', '(if$-else-case|match$-else) prefix*'), ignore),
	('if$-else-case prefix*', ('IF', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*', 'ELSE', 'prefix*', '(if$-else-case|match$-else) prefix*'), ignore),
	...
	('case..', ('CASE', 'postfixed', 'prefix*', '(if|if$-else) prefix*', 'case..'), ignore),
	...
	('match prefix*', ('MATCH', 'postfixed', 'prefix*'), ignore),
	('match prefix*', ('MATCH', 'prefix*', '(if|if$-case|match) prefix*'), ignore),
	('match prefix*', ('MATCH', 'postfixed', 'prefix*', 'case.. prefix*'), ignore),
	('match prefix*', ('MATCH', 'prefix*', '(if|if$-else) prefix*', 'case.. prefix*'), ignore),
	('case.. prefix*', ('CASE', 'postfixed', 'postfixed', 'prefix*', 'case.. prefix*'), ignore),
	('case.. prefix*', ('CASE', 'postfixed', 'prefix*', '(if|if$-else) prefix*', 'case.. prefix*'), ignore),
	('case.. prefix*', ('CASE', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*', 'case.. prefix*'), ignore),
	('case.. prefix*', ('CASE', 'prefix*', '[^postfixed] prefix*', '(if|if$-else) prefix*', 'case.. prefix*'), ignore),
	('case.. prefix*', ('CASE', 'postfixed', 'postfixed', 'prefix*'), ignore),
	('case.. prefix*', ('CASE', 'postfixed', 'prefix*', '(if|if$-case|match) prefix*'), ignore),
	('case.. prefix*', ('CASE', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*'), ignore),
	...
	('case..$-else', ('CASE', 'postfixed', 'prefix*', '(if|if$-else) prefix*', 'case..$-else'), ignore),
	...
	('match$-else prefix*', ('MATCH', 'postfixed', 'prefix*', 'case..$-else prefix*'), ignore),
	('match$-else prefix*', ('MATCH', 'prefix*', '(if|if$-else) prefix*', 'case..$-else prefix*'), ignore),
	('case..$-else prefix*', ('CASE', 'postfixed', 'postfixed', 'prefix*', 'case..$-else prefix*'), ignore),
	('case..$-else prefix*', ('CASE', 'postfixed', 'prefix*', '(if|if$-else) prefix*', 'case..$-else prefix*'), ignore),
	('case..$-else prefix*', ('CASE', 'prefix*', '[^postfixed]', 'postfixed', 'prefix*', 'case..$-else prefix*'), ignore),
	('case..$-else prefix*', ('CASE', 'prefix*', '[^postfixed] prefix*', '(if|if$-else) prefix*', 'case..$-else prefix*'), ignore),
	('case..$-else prefix*', ('CASE', 'postfixed', 'prefix*', '(if$-else|if$-else-case|match$-else) prefix*'), ignore),
